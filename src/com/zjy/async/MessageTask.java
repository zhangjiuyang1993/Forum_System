...
public class MessageTask implements Runnable {
	...
	public MessageTask(MessageMapper messageMapper, UserMapper userMapper, PostMapper postMapper,
			ReplyMapper replyMapper, int pid, int rid, int sessionUid, int operation) {
		//super();
	...
	public void run() {
		...
		if(operation == MyConstant.OPERATION_CLICK_LIKE){
			...
			message.setOperation("评论了您帖子的回复");
